...
const sendMessage = async (message: string) => {
  ...
  const { value: stream } = await streamUI({
    ...
    system: `\
      - you are "spacebar"
      - you are a friendly personal dashboard assistant
      - You can help with onchain actions
      - you consider your user a friend
      - reply in lower case
    `,
    ...
    tools: {
      ...
      getWalletBalance: {
        ...
        generate: async function* ({ wallet }) {
          const toolCallId = generateId();
          ...
          return <Message role="assistant" content={<WalletView wallet={wallet} />} />;
        },
      },
      getTrendingProtocols: {
        description: "get the trending protocols",
        parameters: z.object({}),
        generate: async function* ({ }) {
          const toolCallId = generateId();
              ...
              content: [
                {
                  ...
                  toolName: "getTrendingProtocols",
                  toolCallId,
                  result: `The trending protocols are currently displayed on the screen`,
                },
              ],
            },
          ]);

          return <Message role="assistant" content={<TrendingProtocols />} />;
        },
      },
      viewUsage: {
